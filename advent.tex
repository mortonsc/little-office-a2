...
\title{Vespers and Compline of Our Lady\\In Advent}
\date{ }
...
\latinenglish{
	...
	Egrediétur virga de rádice Jesse,~\GreDagger\
	et flos de rádice ejus ascéndet,~*
...
\latinenglish{
	...
	Bútyrum et mel cómedet, ut sciat reprobáre malum, et elígere bonum.
...
\latinenglish{
	...
	%% TODO: per-annum is missing the "Ant.''
	\textnormal{Ant.}
	The Holy Spirit shall come upon thee, Mary: fear not, thou shalt bear in thy womb the Son of God, alleluia.
}

...
\title{Vespers and Compline of Our Lady\\In Eastertide}
\date{ }
...
\rubric{ All kneel and pray silently. As you begin the prayer \textnormal{Aperi, Domine}, make the sign of the cross with your thumb over your lips and your heart.}

\latinenglishequal{
	Áperi, Dómine, os meum ad benedicéndum nomen sanctum tuum:
	munda quoque cor meum ab ómnibus vanis, pervérsis et aliénis cogitatiónibus;
	intelléctum illúmina, afféctum inflámma, ut digne, atténte ac devóte hoc Offícium beátæ Vírginis\linebreak Maríæ recitáre váleam,
	et exaudíri mérear ante conspéctum divínæ Majestátis tuæ.
	Per Christum\linebreak Dóminum nostrum. 
	Amen.
}{
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{ant1-alleluia}
}{
	\textnormal{Ant.}
	While the King was reposing, my spikenard yielded the odor of sweetness. Alleluia.
}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{ant2-alleluia}
}{
	\textnormal{Ant.}
	His left hand under my head, and his right hand shall embrace me. Alleluia.
}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{ant3-alleluia}
}{
	\textnormal{Ant.}
	I am black, but beautiful, O daughters of Jerusalem: therefore hath the king loved me, and brought me into his chamber. Alleluia.
}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{ant4-alleluia}
}{
	\textnormal{Ant.}
	Now is the winter past, the rain is over and gone: arise, my beloved, and come. Alleluia.
}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{ant5-alleluia}
}{
	\textnormal{Ant.}
	Thou art become beautiful and sweet in thy delights, O holy Mother of God. Alleluia.
}
...
\latinenglish{
	...
	\item Quia fecit mihi \textit{ma}\textit{gna} \textit{qui} \textbf{pot}\textbf{ens} est:~*\linebreak
	et sanctum \textit{no}\textit{men} \textbf{e}jus.

	\item Et misericórdia ejus a progéni\textit{e} \textit{in} \textit{pro}\textbf{gé}\textbf{ni}es~*\linebreak
	...
	\item Glória \textit{Pa}\textit{tri}, \textit{et} \textbf{Fí}\textbf{li}o,~*\linebreak
	et Spirí\textit{tu}\textit{i} \textbf{Sanc}to.
...
\latinenglish{
	...
	tu nos ab hoste prótege, et hora mortis súscipe.
	 ...
	 \setcounter{enumi}{2}
	\item \textit{(in Eastertide)} Qu\'{\ae}sumus, Auctor omnium, in hoc pascháli gáudio,\linebreak
	ab omni mortis ímpetu, tuum defénde pópulum.
	
	\setcounter{enumi}{2}
	\item \textit{(in Ascensiontide)} Tu esto nostrum gáudium,\linebreak
	qui es futúrus pr\'{\ae}mium:\linebreak
	sit nostra in te glória, per cuncta semper s\'{\ae}cula.
	
	 \setcounter{enumi}{2}
	\item \textit{(in Whitsuntide)} Dudum sacráta péctora tua replésti grátia:\linebreak
	Dimítte nostra crímina, et da quiéta témpora.

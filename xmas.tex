...
\title{Vespers and Compline of Our Lady\\In Christmastide}
\date{ }
...
\latinenglish{
	\textbf{Ant. 1.} O admirábile commércium!
}{
...
\latinenglish{
	...
	\item Jurávit Dóminus, et non pœni\textbf{té}bit \textbf{e}um:~*\linebreak
...
\latinenglish{
	\textbf{Ant. 3.} Rubum quem víderat.
}{
...
\latinenglish{
	\textbf{Ant. 5.} Ecce María.
}{
	Behold, Mary.
}

%% TODO: the psalm tone here is wrong, needs to be transposed correctly
\latinenglish{
	\gresetinitiallines{0}
	...
	\item Quóniam confortávit seras por\textbf{tá}rum tu\textbf{á}rum:~*\linebreak
	benedíxit fíliis \textit{tu}\textit{is} \textbf{in} te.

	\item Qui pósuit fines \textbf{tu}os \textbf{pa}cem:~\linebreak
	et ádipe fruménti \textit{sá}\textit{ti}\textbf{at} te.
	
	\item Qui emíttit elóquium \textbf{su}um \textbf{ter}ræ:~*\linebreak
	velóciter currit \textit{ser}\textit{mo} \textbf{e}jus.
	
	\item Qui dat nivem \textbf{sic}ut \textbf{la}nam:~*\linebreak
	nébulam sicut cí\textit{ne}\textit{rem} \textbf{spar}git.
	
	\item Mittit crystállum suam \textbf{sic}ut buc\textbf{cél}las:~*\linebreak
	ante fáciem frígoris ejus quis \textit{sus}\textit{ti}\textbf{né}bit?
	
	\item Emíttet verbum suum, et lique\textbf{fá}ciet \textbf{e}a:~\linebreak
	 flabit spíritus ejus, et \textit{flu}\textit{ent} \textbf{a}quæ.
	
	\item Qui annúntiat verbum \textbf{su}um \textbf{Ja}cob:~*\linebreak
	justítias, et judícia \textit{su}\textit{a} \textbf{Is}raël.
	
	\item Non fecit táliter omni \textbf{na}ti\textbf{ó}ni:~*\linebreak
...
\rubric{After Septuagesima, the version of the antiphon without \textnormal{Alleluia} is sung.}
...
%% TODO: nesciens or nescientis???
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{antcant-xmas}
}{
	\textnormal{Ant.}
	A great mystery of inheritance: the womb of one the knew not man hath become the temple of God;
